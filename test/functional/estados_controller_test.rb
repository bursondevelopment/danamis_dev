...
class EstadosControllerTest < ActionController::TestCase
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post :create, estado: { descripcion: @estado.descripcion, nombre: @estado.nombre, nombre_corto: @estado.nombre_corto }
    end
  ...
  test "should update estado" do
    put :update, id: @estado, estado: { descripcion: @estado.descripcion, nombre: @estado.nombre, nombre_corto: @estado.nombre_corto }
    assert_redirected_to estado_path(assigns(:estado))
  end
