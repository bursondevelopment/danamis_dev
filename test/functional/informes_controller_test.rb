...
class InformesControllerTest < ActionController::TestCase
  ...
  test "should create informe" do
    assert_difference('Informe.count') do
      post :create, informe: { autor: @informe.autor, encabezado: @informe.encabezado, fecha: @informe.fecha, tema: @informe.tema, titulo: @informe.titulo }
    end
  ...
  test "should update informe" do
    put :update, id: @informe, informe: { autor: @informe.autor, encabezado: @informe.encabezado, fecha: @informe.fecha, tema: @informe.tema, titulo: @informe.titulo }
    assert_redirected_to informe_path(assigns(:informe))
  end
