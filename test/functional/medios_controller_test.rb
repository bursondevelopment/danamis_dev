...
class MediosControllerTest < ActionController::TestCase
  ...
  test "should create medio" do
    assert_difference('Medio.count') do
      post :create, medio: { descripcion: @medio.descripcion, impacto: @medio.impacto, logo: @medio.logo, nombre: @medio.nombre }
    end
  ...
  test "should update medio" do
    put :update, id: @medio, medio: { descripcion: @medio.descripcion, impacto: @medio.impacto, logo: @medio.logo, nombre: @medio.nombre }
    assert_redirected_to medio_path(assigns(:medio))
  end
