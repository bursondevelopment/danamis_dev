...
class PaginasControllerTest < ActionController::TestCase
  ...
  test "should create pagina" do
    assert_difference('Pagina.count') do
      post :create, pagina: { articulo: @pagina.articulo, contenido: @pagina.contenido, fecha: @pagina.fecha, imagen: @pagina.imagen, titulo: @pagina.titulo, url: @pagina.url, website_id: @pagina.website_id }
    end
  ...
  test "should update pagina" do
    put :update, id: @pagina, pagina: { articulo: @pagina.articulo, contenido: @pagina.contenido, fecha: @pagina.fecha, imagen: @pagina.imagen, titulo: @pagina.titulo, url: @pagina.url, website_id: @pagina.website_id }
    assert_redirected_to pagina_path(assigns(:pagina))
  end
